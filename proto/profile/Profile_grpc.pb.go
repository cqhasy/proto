...
import (
	...
	common "github.com/cqhasy/proto/proto/common"
)
...
type ProfileTaskClient interface {
	...
	GetProfileTaskCommands(ctx context.Context, in *ProfileTaskCommandQuery, opts ...grpc.CallOption) (*common.Commands, error)
	// collect dumped thread snapshot
	CollectSnapshot(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ThreadSnapshot, common.Commands], error)
	// collect bytes profile data from go agent
	GoProfileReport(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[GoProfileData, common.Commands], error)
	// report profiling task finished
	ReportTaskFinish(ctx context.Context, in *ProfileTaskFinishReport, opts ...grpc.CallOption) (*common.Commands, error)
}
...
func (c *profileTaskClient) GetProfileTaskCommands(ctx context.Context, in *ProfileTaskCommandQuery, opts ...grpc.CallOption) (*common.Commands, error) {
...
func (c *profileTaskClient) CollectSnapshot(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ThreadSnapshot, common.Commands], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ProfileTask_ServiceDesc.Streams[0], ProfileTask_CollectSnapshot_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ThreadSnapshot, common.Commands]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ProfileTask_CollectSnapshotClient = grpc.ClientStreamingClient[ThreadSnapshot, common.Commands]

func (c *profileTaskClient) GoProfileReport(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[GoProfileData, common.Commands], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ProfileTask_ServiceDesc.Streams[1], ProfileTask_GoProfileReport_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GoProfileData, common.Commands]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ProfileTask_GoProfileReportClient = grpc.ClientStreamingClient[GoProfileData, common.Commands]

func (c *profileTaskClient) ReportTaskFinish(ctx context.Context, in *ProfileTaskFinishReport, opts ...grpc.CallOption) (*common.Commands, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Commands)
...
type ProfileTaskServer interface {
	// query all sniffer need to execute profile task commands
	GetProfileTaskCommands(context.Context, *ProfileTaskCommandQuery) (*common.Commands, error)
	// collect dumped thread snapshot
	CollectSnapshot(grpc.ClientStreamingServer[ThreadSnapshot, common.Commands]) error
	// collect bytes profile data from go agent
	GoProfileReport(grpc.ClientStreamingServer[GoProfileData, common.Commands]) error
	// report profiling task finished
	ReportTaskFinish(context.Context, *ProfileTaskFinishReport) (*common.Commands, error)
...
func (UnimplementedProfileTaskServer) GetProfileTaskCommands(context.Context, *ProfileTaskCommandQuery) (*common.Commands, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProfileTaskCommands not implemented")
}
func (UnimplementedProfileTaskServer) CollectSnapshot(grpc.ClientStreamingServer[ThreadSnapshot, common.Commands]) error {
	return status.Errorf(codes.Unimplemented, "method CollectSnapshot not implemented")
}
func (UnimplementedProfileTaskServer) GoProfileReport(grpc.ClientStreamingServer[GoProfileData, common.Commands]) error {
	return status.Errorf(codes.Unimplemented, "method GoProfileReport not implemented")
}
func (UnimplementedProfileTaskServer) ReportTaskFinish(context.Context, *ProfileTaskFinishReport) (*common.Commands, error) {
...
func _ProfileTask_CollectSnapshot_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ProfileTaskServer).CollectSnapshot(&grpc.GenericServerStream[ThreadSnapshot, common.Commands]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ProfileTask_CollectSnapshotServer = grpc.ClientStreamingServer[ThreadSnapshot, common.Commands]

func _ProfileTask_GoProfileReport_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ProfileTaskServer).GoProfileReport(&grpc.GenericServerStream[GoProfileData, common.Commands]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ProfileTask_GoProfileReportServer = grpc.ClientStreamingServer[GoProfileData, common.Commands]
