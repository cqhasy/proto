...
const file_profile_Profile_proto_rawDesc = "" +
	...
	"\x10reportTaskFinish\x12&.skywalking.v3.ProfileTaskFinishReport\x1a\x17.skywalking.v3.Commands\"\x00Bp\n" +
	"5org.apache.skywalking.apm.network.language.profile.v3P\x01Z\x15proto/profile;profile\xaa\x02\x1dSkyWalking.NetworkProtocol.V3b\x06proto3"
...
var file_profile_Profile_proto_goTypes = []any{
	...
	(*common.Commands)(nil),         // 5: skywalking.v3.Commands
}
